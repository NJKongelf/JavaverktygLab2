...
public class CalculaterTest {
    ...
    void calcAddition_ShouldReturnSumOFTheFirstTwoValueInSource(Double num1,Double num2,double num3,TestInfo testInfo){
    ...
    void calcDivide_shouldReturnSmallerDouble(TestInfo testInfo){
    ...
    void calcSubstract_ShouldReturnALowerResult(TestInfo testInfo){
    ...
    void calcServalMethods(TestInfo testInfo){
